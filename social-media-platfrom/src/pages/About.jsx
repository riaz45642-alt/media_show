...
export default function About() {
  return (
    <div>
      <PageHeader title="About SafeZone" />
      <div className="soft-card p-6 space-y-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-display font-bold text-gray-800 dark:text-gray-100">SafeZone</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Version 1.0.0</p>
          </div>
        </div>
        <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
          SafeZone is an ad-free, safety-first space built for kids and teenagers to share ideas, watch
