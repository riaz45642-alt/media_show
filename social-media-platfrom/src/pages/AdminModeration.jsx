...
import { ShieldAlert, Check, X, RotateCcw, Ban } from 'lucide-react'
...
export default function AdminModeration() {
  ...
  return (
    <div className="mx-auto max-w-3xl p-4">
      <h1 className="mb-4 flex items-center gap-2 text-xl font-bold"><ShieldAlert size={22} /> Moderation Queue</h1>
