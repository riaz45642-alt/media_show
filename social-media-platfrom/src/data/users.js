...
export const AI_ASSISTANT_ID = 'help-guide'

export const USERS = [
  { id: AI_ASSISTANT_ID, name: 'Help Guide', color: '#4A90E2', avatar: '', isPrivate: false, hasStory: false, isOnline: true, gender: '', isSupport: true },
