...
export const MY_SEED_POSTS = [
  ...
  },
  {
    ...
    time: '1d ago',
    type: 'text',
    text: 'Quick rant about my group project teammates being slow to reply...',
    media: [],
    likes: 4,
    comments: [],
    tag: 'Life',
    ...
    moderation_reason: 'Language flagged as potentially harsh/negative tone toward others.',
    risk_score: 42,
    own: true,
  },
  {
    ...
    time: '6d ago',
    type: 'text',
    text: 'Meme caption that got auto-rejected by the filter for a borderline joke.',
    media: [],
    likes: 0,
    comments: [],
    tag: 'Humor',
    ...
    moderation_reason: 'Matched a rule-based filter for edgy humor near a sensitive keyword.',
    risk_score: 68,
    own: true,
  },
]
