...
export const searchUsers = (search = '') => request(`/users?search=${encodeURIComponent(search)}`)
export const addMembers = (groupId, userIds) =>
  request(`/groups/${groupId}/members`, { method: 'POST', body: JSON.stringify({ userIds }) })
