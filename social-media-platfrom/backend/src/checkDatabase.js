...
const requiredColumns = {
  ...
  user_settings: ['user_id', 'profile_visibility', 'messaging_enabled', 'parent_password_hash', 'daily_screen_time_minutes'],
  user_daily_usage: ['user_id', 'usage_date', 'active_seconds'],
  screen_time_sessions: ['user_id', 'session_id', 'usage_date', 'last_heartbeat_at'],
